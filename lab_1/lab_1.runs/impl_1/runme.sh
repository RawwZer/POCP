...
HD_PWD='C:/Users/ya.zhuk/Desktop/POCP/lab_1/lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log express.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source express.tcl -notrace
