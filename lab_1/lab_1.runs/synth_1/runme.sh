...
HD_PWD='C:/Users/ya.zhuk/Desktop/POCP/lab_1/lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log express.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source express.tcl
