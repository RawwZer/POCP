...
HD_PWD='C:/Users/ya.zhuk/Desktop/POCP/lab_3/lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_ff_with_ares_sset.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d_ff_with_ares_sset.tcl
